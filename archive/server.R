...
shinyServer(function(input, output, session) {
  ...
  readData <- function(populationsRF_DF){
    ...
    populationRF_r_urban <- read.xlsx(paste(getwd(),"/Data/1.5.xls", sep = ""), sheetIndex = 1, startRow = 36, endRow = 57, header = F)
    ...
    populationRF_r_rural <- read.xlsx(paste(getwd(),"/Data/1.5.xls", sep = ""), sheetIndex = 1, startRow = 64, endRow = 85, header = F)
  ...
  readKoefs <- function(birthKoefs_DF, deathKoefs_DF){
    #Koefs structure
    #Birth
    birthKoefs_r_urban <- read.xlsx(paste(getwd(),"/Data/4.3.xls", sep = ""), sheetIndex = 1, startRow = 42, endRow = 61, header = F)
    ...
    birthKoefs_r_rural <- read.xlsx(paste(getwd(),"/Data/4.3.xls", sep = ""), sheetIndex = 1, startRow = 70, endRow = 89, header = F)
    ...
    #Death
    deathKoefs_r_urban <- read.xlsx(paste(getwd(),"/Data/5.2.xls", sep = ""), sheetIndex = 1, startRow = 33, endRow = 51, header = F)
    ...
    deathKoefs_r_rural <- read.xlsx(paste(getwd(),"/Data/5.2.xls", sep = ""), sheetIndex = 1, startRow = 55, endRow = 73, header = F)
